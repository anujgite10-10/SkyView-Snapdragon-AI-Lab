...
class Settings:
    ...
    def __init__(self):
        ...
        # ==================== SNAPDRAGON HP PC & QUALCOMM AI HUB ====================
        self.SNAPDRAGON_PLATFORM: str = os.getenv("SNAPDRAGON_PLATFORM", "Snapdragon X Elite / HP PC")
        self.ENABLE_SNAPDRAGON_NPU: bool = os.getenv("ENABLE_SNAPDRAGON_NPU", "True").lower() == "true"
        self.SNAPDRAGON_NPU_TOPS: int = int(os.getenv("SNAPDRAGON_NPU_TOPS", "45"))
        self.QUALCOMM_AI_HUB_MODEL: str = os.getenv("QUALCOMM_AI_HUB_MODEL", "mobilenet_v4_crop_disease")
        self.QUALCOMM_EXECUTION_PROVIDER: str = os.getenv("QUALCOMM_EXECUTION_PROVIDER", "QNNExecutionProvider")

        # ==================== EDGE AI & FIELD GATEWAY ====================
        self.ENABLE_EDGE_AI: bool = os.getenv("ENABLE_EDGE_AI", "True").lower() == "true"
        self.ARDUINO_Q_HOST: str = os.getenv("ARDUINO_Q_HOST", "localhost")
        ...
        # On-device LLM running on Snapdragon HP PC (Qualcomm Hexagon NPU / Ollama / ONNX)
        ...
        # FPGA (AMD ZYNQ-7000) connects via UART
